...
import sys
path ='/Users/ant/Documents/Data_science/08_ETAM/Mes projets/users'
...
def load_data(
    today = today, ticker ='AI.PA'
):
    """

    Args:
        data: Data containing stock & oil price
        parameters: tickers / countries
    Returns:
        price data.
    """
    ...
    #c.date_end  =today #'2022-01-01'
    #spy_ohlc_df = yf.download('SPY', start=c.date_start, end=c.date_end)
    div = 1000000
    # Request historical data
    data = yf.Ticker(ticker)
    
    list_features = ['Total Assets','Current Assets','Total Non Current Assets',
    'Total Liabilities Net Minority Interest', 'Current Liabilities', 'Total Non Current Liabilities Net Minority Interest',
    'Net Tangible Assets',#'Common Stock Equity',
    ]

    print(data)
    # # Actif, PAssif, CP
    # balancesheet= data.balancesheet.loc[list_features]#/div
    # print(balancesheet.head(1))
    # return balancesheet.head(1)
    return div 
